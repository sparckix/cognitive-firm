...
PATTERN-012 calibration analyzer. Sibling to scripts/validate_prediction_ledger.py:
...
Pre-registered against PL-017. Read-only on analytics/prediction_ledger.jsonl;
writes only analytics/prediction_ledger_calibration_summary.json plus stdout.
...
Usage:
  python scripts/score_prediction_ledger_calibration.py [path]

Default path: analytics/prediction_ledger.jsonl
Default output: analytics/prediction_ledger_calibration_summary.json
"""
...
LEDGER_DEFAULT = Path("analytics/prediction_ledger.jsonl")
SUMMARY_DEFAULT = Path("analytics/prediction_ledger_calibration_summary.json")
