...
Usage:
    python -m src.cognitive_firm.orchestration.goals_inbox_cli list [--assigned-to role.manager]
    python -m src.cognitive_firm.orchestration.goals_inbox_cli show <goal_id>
...
from src.cognitive_firm.orchestration import goals_inbox as gi
