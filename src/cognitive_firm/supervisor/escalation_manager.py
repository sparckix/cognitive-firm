...
def escalate(
    *,
    ...
    if session_id is not None:
        from cognitive_firm.signals import autoemit
    ...
    if urgent:
        try:
            ...
            from cognitive_firm.notifications.push import push_notification
...
def escalate_gate_file_also_push(
    ...
    if not gate_json_path.exists():
        ...
        return False
    try:
        from cognitive_firm.notifications.push import push_from_gate_json
    except ImportError:
