...
def run_supervisor_staging_fixture_regression() -> dict[str, object]:
    ...
    b_status = HandoffStatus(
        **{
            **b_status.__dict__,
            ...
            "verification_command": "python -m src.cognitive_firm.validator.core.stage2_derivation_fixture_regression && python -m src.cognitive_firm.validator.core.stage24_bridge_fixture_regression && python -m src.cognitive_firm.validator.stage4_fixture_regression",
    ...
    c_status = HandoffStatus(
        ...
        verification_command="python -m src.cognitive_firm.validator.core.stage2_derivation_fixture_regression",
    )
    ...
    results = [
        ...
        },
        {
            ...
            == "python -m src.cognitive_firm.validator.core.stage2_derivation_fixture_regression && python -m src.cognitive_firm.validator.core.stage24_bridge_fixture_regression && python -m src.cognitive_firm.validator.stage4_fixture_regression",
        },
        {
            ...
            == "python -m src.cognitive_firm.findings.prose_verifier --draft-path research_areas/drafts/paper4_drafting_paper_outline.md --spec-path research_areas/specs/paper4_drafting_paper_outline_prose_spec.json",
        },
        {
