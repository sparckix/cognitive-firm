    ...
    with tempfile.TemporaryDirectory(prefix="supervisor_wrapper_fixture_") as tmp:
        ...
        try:
            ...
            case_research_b_passed = (
                ...
                and "`verification_command`: `python -m src.cognitive_firm.findings.prose_verifier --draft-path research_areas/drafts/paper4_drafting_paper_outline.md --spec-path research_areas/specs/paper4_drafting_paper_outline_prose_spec.json`" in research_b_prompt
            )
        finally:
        ...
        supervisor_wrappers_module._call_anthropic_research_b_api = lambda **kwargs: APITransportResult(
            request_payload={
                ...
                "verification_command": "python -m src.cognitive_firm.findings.prose_verifier --draft-path research_areas/drafts/paper4_drafting_paper_outline.md --spec-path research_areas/specs/paper4_drafting_paper_outline_prose_spec.json",
            },
            artifacts=(
                (
                    "research_areas/drafts/paper4_drafting_paper_outline.md",
